...
Capra Slack: `#capracon-second-brain` (or the thread the crew pointed you at). Share:

- A screenshot of your graph after 1 week
- A skill you built that others might want
- A moment where the vault saved you from forgetting something important

The crew (Magnus, Rune, Vemund) are around for follow-up questions.

---

## Not covered today - might be a future workshop

- Claude Code on AWS Bedrock / Azure for EA-free enterprise deployments
- Playwright MCP for agent-driven browser automation (Magnus demo'd this in the talk)
- Multi-vault setups (personal + work + client, with separate agent contexts)
- Voice capture pipelines (record -> transcribe -> vault)
- Agent-driven weekly reviews / monthly retrospectives

If any of those interest you enough to attend, say so in Slack. That is how the next workshop gets picked.
